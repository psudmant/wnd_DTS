...
#gorgor3.1
#wnd_contigs=/net/eichler/vol7/home/psudmant/EEE_Lab/1000G/1000genomesScripts/windowed_analysis/DTS_window_analysis/windows/gorGor3.1_slide/500_bp_windows.pkl.contigs
#sunk_wnd_contigs=/net/eichler/vol7/home/psudmant/EEE_Lab/1000G/1000genomesScripts/windowed_analysis/DTS_window_analysis/windows/gorGor3.1_slide/500_bp_windows.pkl.contigs
...
#in_dir=/net/eichler/vol19/projects/human_population_sequencing/nobackups/psudmant/wnd_output_DTS/gorGor3.1/MNT_GORILLA/500_bp_slide/
#sunk_in_dir=/net/eichler/vol19/projects/human_population_sequencing/nobackups/psudmant/wnd_output_DTS/gorGor3.1/MNT_GORILLA/500_bp_sunk_slide/
...
#gglob_dir=/net/eichler/vol19/projects/human_population_sequencing/nobackups/psudmant/wnd_output_DTS/gorGor3.1/MNT_GORILLA/gglob
wnd_slide=100
wnd_size=500
...
then
    ...
    do
        echo which python';' source ~/.bash_profile ';' which python ';' python ~psudmant/EEE_Lab/projects/common_code/ssf_DTS_caller/gglob.py  --contigs $wnd_contigs --in_DTS_dir $in_dir --gglob_dir $gglob_dir --wnd_size $wnd_size --wnd_slide $wnd_slide --sunk_contigs $sunk_wnd_contigs --in_sunk_DTS_dir $sunk_in_dir --setup_chr $chr
    done
fi
